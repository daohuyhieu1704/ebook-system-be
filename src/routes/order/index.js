...
// Book's functions
router.post("/shop/add-to-cart", jwtMiddleware, new OrderController().postAddToCart);
router.post("/shop/purches-items", jwtMiddleware, new OrderController().postPurchesItems);
...
router.get("/shop/order-history", jwtMiddleware, new OrderController().getOrderHistory);
